<template>
  <section class="pb-16 bg-blueGray-200 relative pt-16">
    <!--<div
...
export default {
  ...
  methods: {
    ...
    datPhong(id) {
      window.location.assign(`/employee/dat-phong/${id}/${this.checkIn}/${this.checkOut}`);
    },
    getInfor(id) {
      window.location.assign(`/employee/list-phong/${id}/${this.checkIn}/${this.checkOut}`);
    }
  },
};
</script>
